...
class Game {
  ...
  difficulty(ctx) {
    if (this.level === 'easy') {
      ...
      this.player1 = new Bikes(752,351,10,10,'rgba(255, 0, 102, 1)', 'left');
      this.player2 = new Bikes(151,351,10,10,'rgba(247, 255, 0, 1)', 'right');
  ...
  endGame(ctx) {
    this.player1.collideWalls(this.gameBorderXmin, this.gameBorderXmax, this.gameBorderYmin, this.gameBorderYmax);
    this.player2.collideWalls(this.gameBorderXmin, this.gameBorderXmax, this.gameBorderYmin, this.gameBorderYmax);
